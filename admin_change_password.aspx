<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="admin_change_password.aspx.cs" Inherits="farmerapp.admin_change_password" %>
...
<asp:TextBox placeholder="Enter Your Password" ID="txtpass" 
        CssClass="form-control form-control-sm" runat="server" TextMode="Password"></asp:TextBox>
    ...
    <br />
    <br />
         <asp:Button CssClass="btn btn-outline-success btn-sm" ID="btnchange" 
